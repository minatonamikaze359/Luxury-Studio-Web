...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'chat') {
    ...
    $apiUrl = 'https://apis.davidcyril.name.ng/ai/gpt-5.5?prompt=' . urlencode($userPrompt);
    ...
    // Safely extract message payload from API output
    $aiReply = '';
    if (is_array($data)) {
...
<head>
    ...
    <title>GPT-5.5 AI | Luxury Studio Web</title>
    <!-- Favicon -->
    ...
    <div class="chat-container">
        ...
        <div class="chat-box" id="chatBox">
            ...
            <div class="message ai">
                ...
                <div class="message-content">Hello! I am GPT-5.5 AI. How can I assist you today?</div>
            </div>
    ...
    <script>
        ...
        chatForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch('gpt5.php', {
                    method: 'POST',
                    body: formData
                });
